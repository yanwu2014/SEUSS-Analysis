...
min.regress.cells <- 5 ## Minimum number of cells to test for marker genes
max.guides <- 2 ## Max number of guides detected per cell
n.rand <- 48 ## Number of permutations
...
pt <- proc.time()
coefs <- CalcGlmnet(guides.matrix, covs.df, log.counts, alpha, lambda.use, "mgaussian", ctrl = ctrl)
