...
min.regress.cells <- 10 ## Minimum number of cells to test for marker genes
...
# Build design matrix
guides.matrix <- Matrix(DesignMatrixGenotypes(genotypes.list, max.guides, min.regress.cells, drop.cells = drop.cells))
...
coefs.df <- CalcGlmnetPvals(guides.matrix, covs.df, log.counts, alpha, best.lambda, "mgaussian", n.rand, n.cores, 
